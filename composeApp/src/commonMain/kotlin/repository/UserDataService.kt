...
class UserDataService(private val postman: Postman) {
    ...
    private fun getModulesInTrackTag(idTrack: Int) = "/getModules?idTrack=$idTrack"
    ...
    suspend fun sendMessage(message: String): Resource<List<String>> {
